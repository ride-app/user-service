...
// Package mock_saved_location is a generated GoMock package.
package mock_saved_location
...
func (m *MockSavedLocationRepository) CreateSavedLocation(arg0 context.Context, arg1 *v1alpha1.SavedLocation, arg2 logger.Logger) (*time.Time, error) {
	m.ctrl.T.Helper()
...
func (m *MockSavedLocationRepository) GetSavedLocation(arg0 context.Context, arg1, arg2 string, arg3 logger.Logger) (*v1alpha1.SavedLocation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSavedLocation", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(*v1alpha1.SavedLocation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSavedLocationRepository) GetSavedLocations(arg0 context.Context, arg1 string, arg2 logger.Logger) ([]*v1alpha1.SavedLocation, error) {
	m.ctrl.T.Helper()
...
func (m *MockSavedLocationRepository) UpdateSavedLocation(arg0 context.Context, arg1 *v1alpha1.SavedLocation, arg2 logger.Logger) (*time.Time, error) {
	m.ctrl.T.Helper()
