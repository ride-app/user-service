...
type userServiceClient struct {
	...
	updateUser          *connect_go.Client[v1alpha1.UpdateUserRequest, v1alpha1.UpdateUserResponse]
	deleteUser          *connect_go.Client[v1alpha1.DeleteUserRequest, v1alpha1.DeleteUserResponse]
	createSavedLocation *connect_go.Client[v1alpha1.CreateSavedLocationRequest, v1alpha1.CreateSavedLocationResponse]
	listSavedLocations  *connect_go.Client[v1alpha1.ListSavedLocationsRequest, v1alpha1.ListSavedLocationsResponse]
	getSavedLocation    *connect_go.Client[v1alpha1.GetSavedLocationRequest, v1alpha1.GetSavedLocationResponse]
	updateSavedLocation *connect_go.Client[v1alpha1.UpdateSavedLocationRequest, v1alpha1.UpdateSavedLocationResponse]
	deleteSavedLocation *connect_go.Client[v1alpha1.DeleteSavedLocationRequest, v1alpha1.DeleteSavedLocationResponse]
}
...
func (c *userServiceClient) UpdateUser(ctx context.Context, req *connect_go.Request[v1alpha1.UpdateUserRequest]) (*connect_go.Response[v1alpha1.UpdateUserResponse], error) {
...
func (c *userServiceClient) CreateSavedLocation(ctx context.Context, req *connect_go.Request[v1alpha1.CreateSavedLocationRequest]) (*connect_go.Response[v1alpha1.CreateSavedLocationResponse], error) {
...
func (c *userServiceClient) ListSavedLocations(ctx context.Context, req *connect_go.Request[v1alpha1.ListSavedLocationsRequest]) (*connect_go.Response[v1alpha1.ListSavedLocationsResponse], error) {
	return c.listSavedLocations.CallUnary(ctx, req)
}

// GetSavedLocation calls ride.rider.v1alpha1.UserService.GetSavedLocation.
func (c *userServiceClient) GetSavedLocation(ctx context.Context, req *connect_go.Request[v1alpha1.GetSavedLocationRequest]) (*connect_go.Response[v1alpha1.GetSavedLocationResponse], error) {
	return c.getSavedLocation.CallUnary(ctx, req)
}

// UpdateSavedLocation calls ride.rider.v1alpha1.UserService.UpdateSavedLocation.
func (c *userServiceClient) UpdateSavedLocation(ctx context.Context, req *connect_go.Request[v1alpha1.UpdateSavedLocationRequest]) (*connect_go.Response[v1alpha1.UpdateSavedLocationResponse], error) {
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	userServiceCreateSavedLocationHandler := connect_go.NewUnaryHandler(
		UserServiceCreateSavedLocationProcedure,
		svc.CreateSavedLocation,
		opts...,
	)
	userServiceListSavedLocationsHandler := connect_go.NewUnaryHandler(
		UserServiceListSavedLocationsProcedure,
		svc.ListSavedLocations,
		opts...,
	)
	userServiceGetSavedLocationHandler := connect_go.NewUnaryHandler(
		UserServiceGetSavedLocationProcedure,
		svc.GetSavedLocation,
		opts...,
	)
	userServiceUpdateSavedLocationHandler := connect_go.NewUnaryHandler(
		UserServiceUpdateSavedLocationProcedure,
		svc.UpdateSavedLocation,
		opts...,
	)
	userServiceDeleteSavedLocationHandler := connect_go.NewUnaryHandler(
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect_go.Request[v1alpha1.GetUserRequest]) (*connect_go.Response[v1alpha1.GetUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("ride.rider.v1alpha1.UserService.GetUser is not implemented"))
}

func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect_go.Request[v1alpha1.UpdateUserRequest]) (*connect_go.Response[v1alpha1.UpdateUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("ride.rider.v1alpha1.UserService.UpdateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeleteUser(context.Context, *connect_go.Request[v1alpha1.DeleteUserRequest]) (*connect_go.Response[v1alpha1.DeleteUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("ride.rider.v1alpha1.UserService.DeleteUser is not implemented"))
}

func (UnimplementedUserServiceHandler) CreateSavedLocation(context.Context, *connect_go.Request[v1alpha1.CreateSavedLocationRequest]) (*connect_go.Response[v1alpha1.CreateSavedLocationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("ride.rider.v1alpha1.UserService.CreateSavedLocation is not implemented"))
}

func (UnimplementedUserServiceHandler) ListSavedLocations(context.Context, *connect_go.Request[v1alpha1.ListSavedLocationsRequest]) (*connect_go.Response[v1alpha1.ListSavedLocationsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("ride.rider.v1alpha1.UserService.ListSavedLocations is not implemented"))
}

func (UnimplementedUserServiceHandler) GetSavedLocation(context.Context, *connect_go.Request[v1alpha1.GetSavedLocationRequest]) (*connect_go.Response[v1alpha1.GetSavedLocationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("ride.rider.v1alpha1.UserService.GetSavedLocation is not implemented"))
}

func (UnimplementedUserServiceHandler) UpdateSavedLocation(context.Context, *connect_go.Request[v1alpha1.UpdateSavedLocationRequest]) (*connect_go.Response[v1alpha1.UpdateSavedLocationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("ride.rider.v1alpha1.UserService.UpdateSavedLocation is not implemented"))
}

func (UnimplementedUserServiceHandler) DeleteSavedLocation(context.Context, *connect_go.Request[v1alpha1.DeleteSavedLocationRequest]) (*connect_go.Response[v1alpha1.DeleteSavedLocationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("ride.rider.v1alpha1.UserService.DeleteSavedLocation is not implemented"))
}
